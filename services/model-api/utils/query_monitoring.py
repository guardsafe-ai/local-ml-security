"""
Model API Service - Query Performance Monitoring
...
class QueryMonitor:
    """Query performance monitor for model-api service"""
...
async def get_model_api_query_monitor() -> QueryMonitor:
    """Get or create model-api service query monitor"""
    async with _monitor_lock:
        if "model_api" not in _query_monitors:
            _query_monitors["model_api"] = QueryMonitor("model_api")
        return _query_monitors["model_api"]
...
async def log_model_api_query_performance():
